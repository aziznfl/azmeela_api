...
type ProductSizeWithCustomerType struct {
	ID               int    `gorm:"column:id_product_size"`
	Name             string `gorm:"column:name"`
	CustomerTypeID   int    `gorm:"column:customer_type_id"`
	CustomerTypeName string `gorm:"column:customer_type_name"`
}
...
type ProductRepository interface {
	...
	FetchProductSizes(ctx context.Context) ([]ProductSize, error)
	CreateProductSize(ctx context.Context, size *ProductSize) error
	UpdateProductSize(ctx context.Context, size *ProductSize) error
	DeleteProductSize(ctx context.Context, id int) error
...
type ProductUsecase interface {
	...
	GetAllProductSizes(ctx context.Context) ([]ProductSize, error)
	CreateProductSize(ctx context.Context, req *ProductSize) error
	UpdateProductSize(ctx context.Context, req *ProductSize) error
	DeleteProductSize(ctx context.Context, id int) error

	CreateProductPrice(ctx context.Context, req *ProductPrice) error
	UpdateProductPrice(ctx context.Context, req *ProductPrice) error
